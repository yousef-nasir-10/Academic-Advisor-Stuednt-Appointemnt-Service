        ...
        <div className='w-full flex flex-col items-center justify-between'>
            ...
            <form class="flex flex-col w-full p-4 ">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="website" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div className='relative z-0 w-full mb-5 group'>
                        ...
                        <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected>Choose a depatrment </option>
                ...
                <div className='flex   items-center justify-center   mt-10 border-t-2 border-black max-xl:flex-col pt-10 '>
                    <div className='flex w-2/6  justify-start max-xl:w-full  '>
                        <div className='flex justify-center items-center    mx-2 max-xl:flex-col'>
                            ...
                            <TimePicker value={value} onChange={onChange} format='HH:mm' />
                        </div>
                    ...
                    <div class="relative z-0 w-3/6 max-xl:w-full  mb-5 group">
                        <input type="text" name="fee" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className='flex   items-center justify-around max-xl:grid-cols-3  '>
