...
import { BookAppointment, GetDoctorAppointments, GetDoctorAppointmentsOnDate, GetUserAppointments } from '../API/appointments'
...
const Home = () => {
  ...
  const stats = [
    { name: 'Upcoming sesstion', stat: sesstion.approved, previousStat: '70,946', change: '12%', changeType: 'increase' },
    { name: 'Pending Sesstion', stat: sesstion.pending, previousStat: '56.14%', change: '2.02%', changeType: 'increase' },
    { name: 'Canceled Sesstion', stat: sesstion.canceled, previousStat: '28.62%', change: '4.05%', changeType: 'decrease' },
  ]
